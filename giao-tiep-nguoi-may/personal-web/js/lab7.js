    ...
    <h2 class="text-center mb-2 text-decoration-underline">Thiết kế ban đầu</h2>
                   <div class="row justify-content-center mt-4">
                     <div class="col-5 ">
                        ...
                        <div class="text-center"><a class="btn btn-success" href="./images/page-lab7.jpg" download>Tải ảnh</a></div>
                        <div class="text-center"><img id="thietKeTrenGiay" src="./images/page-lab7.jpg" class="img-fluid mt-2" alt="img"> </div>
                     </div>
                     <div class="col-5">
                         <h3 class="text-center">Thiết kế trên HTML</h3>
                        <div class='d-flex justify-content-center gap-2'>
                            <div class="text-center"><a class="btn btn-success" href="./images/figma-lab7.png" download>Tải ảnh</a></div>
                            <div class="text-center"><a class="btn btn-danger" href="https://www.figma.com/community/file/1320066345934770595" target='_blank' download>Go to figma</a></div>
                        </div>
                        <div class="text-center"><img id="thietKeTrenHtml" src="./images/figma-lab7.png" class="img-fluid mt-2" alt="img"> </div>
                     </div>
                   </div>
    `;
}
